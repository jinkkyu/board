									...
									<tbody id="tbody">
										...
										<tr>
											...
											<td colspan="3"><textarea id="board_content"
													name="board_content" cols="50" rows="5" class="form-control"></textarea></td>
										</tr>
										<tr>
											<th>첨부파일</th>
											<td colspan="3" id="file_td"><input type="file" class="form-control"
												id="files[0]" name="files[0]" value=""></td>
										</tr>
									</tbody>
								</table>
